...
async function register_user(user, handle_register) {
  ...
  if (user.password !== user.confirm_password) {
    document.getElementsByClassName("passwords-message")[0].style.display =
      "block";
  } else {
...
function get_email(e) {
  ...
  document.getElementsByClassName("registeration-message")[0].style.display =
    "none";
}
