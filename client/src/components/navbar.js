    ...
    <Navbar expand="lg" className='px-2'>
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll" className="justify-content-end">
          {isadmin=='true' && 
             <Button className='mx-2' variant="dark" onClick={()=>navigate('/manage_users')}>
             USERS
           </Button>
          }
  
          {isadmin=='true' &&
             <Button className='mx-2' variant="dark" onClick={() => navigate('/manage_buses')}>
             BUSES
           </Button>
          }
          ...
          {uid ? (
            ...
            <Button className='mx-2' variant="outline-0" onClick={() => handleLogout()}>
