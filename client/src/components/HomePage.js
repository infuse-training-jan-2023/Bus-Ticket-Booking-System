		...
		<Container fluid style={{height: '100vh', width:'100vw'}} className='p-0'>
			<Carousel className='h-100 w-100'>
				<Carousel.Item className='h-100'>
					...
					<Carousel.Caption className='position-fixed' style={{top: '15%'}}>
						<Row xs={12} className='m-2 text-center p-5'>
							<Col style={{fontSize: '5em', textShadow: '5px 5px 10px red'}}>INFUSE BUS TRAVELS</Col>
						</Row>
						<Row xs={12} className='m-2 text-center p-4'>
							<Col style={{fontSize: '3em'}}>Test Our Buses for Us</Col>
						</Row>
						<Row>
							<Col className='text-center'>
								<Button as='a' variant='danger' className='w-25 p-3' style={{fontSize: '2.5em'}}> Get Started </Button>
							</Col>
						</Row>
					</Carousel.Caption>
				</Carousel.Item>
